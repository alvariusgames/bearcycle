...
public enum FSMProcessType {PROCESS, PHYSICS_PROCESS}
public abstract class FSMKinematicBody2D<StateEnum> : KinematicBody2D, IFSMObject<StateEnum>, ITimestepInterpolatable {
    [Export]
